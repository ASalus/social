...
@section('link', route('register'))
@section('linkName', 'Create new account')
@section('orText', 'or enter to your account')
...
@section('content')
    <form method="POST" action="{{ route('login') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
        ...
        <div class="pb-2 pt-4">
            <input class="block w-full p-4 text-lg rounded-sm bg-black form-control @error('password') is-invalid @enderror"
        ...
        <div class="flex text-right text-gray-400">
            <div class="">
            ...
            <div class="grow">
                @if (Route::has('password.request'))
                    <a class="hover:text-gray-100 hover:underline" href="{{ route('password.request') }}">Forgot your
                        password?</a>
                @endif
            </div>
        </div>
