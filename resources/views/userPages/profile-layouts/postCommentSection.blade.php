<div class="user-posts">
    <div class="flex flex-shrink-0 p-4 pb-0">
        <a href="#" class="flex-shrink-0 group block">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-base leading-6 font-medium text-blueGray-700">
                        Sonali Hirave
    ...
    <div class="pl-16">
        <p class="width-auto tw-post-text">
            Day 07 of the challenge <span class="text-blue-600">#100DaysOfCode</span>
            I was wondering what I can do with <span class="text-blue-600">#tailwindcss</span>, so just started building Twitter UI using Tailwind and so far it looks so promising. I will post my code after completion.
            [07/100]
            <span class="text-blue-600"> #WomenWhoCode #CodeNewbie</span>
        </p>
                ...
                <div class="flex items-center">
                    <div class="flex-1 text-center">
                        <a href="#" class="tw-post-links">
                            <svg class="text-center h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" data-darkreader-inline-stroke="" style="--darkreader-inline-stroke:currentColor;">
