@extends('layouts.user.user', ['user'=> $data])

@section('background-image', asset('storage/' . $data->userInfo->background))
@section('content')

<main class="profile-page">
    <section class="relative block" style="height: 500px;">
        <div class="absolute top-0 w-full h-full bg-center bg-cover object-cover" style="background-image: url(@yield('background-image'));">
        ...
        <div class="container mx-auto px-4">
            <div class="tw-profile-container">
                <div class="px-6">
                    ...
                    @livewire('user-profile.upper-part', ['data'=> $data])

                    @livewire('user-profile.about', ['data'=> $data])
                    <div class="tw-profile-posts-container">
                        ...
                        @livewire('user-posts', ['user'=> $data->id])
                    </div>
                </div>
            </div>
        </div>
